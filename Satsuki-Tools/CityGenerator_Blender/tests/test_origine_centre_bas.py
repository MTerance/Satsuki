...
try:
    ...
    if "city_block_generator" in sys.modules:
        from city_block_generator.generator import create_cube_with_center_bottom_origin, set_origin_to_center_bottom
        ...
        print("   ❌ Module city_block_generator non chargé")
