...
def test_addon_loading():
    ...
    addon_path = "city_block_generator_6_12"
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("city_block_generator_6_12", init_path)
        addon_module = importlib.util.module_from_spec(spec)
        
        # Ajouter le module à sys.modules avant l'exécution
        sys.modules["city_block_generator_6_12"] = addon_module
    ...
    for submodule_name in submodules:
        try:
            ...
            spec = importlib.util.spec_from_file_location(
                f"city_block_generator_6_12.{submodule_name}", 
                submodule_path
            )
            submodule = importlib.util.module_from_spec(spec)
            
            # Ajouter à sys.modules
            sys.modules[f"city_block_generator_6_12.{submodule_name}"] = submodule
