bl_info = {
    ...
    "description": "VARIETY UPDATE: 6x more visual diversity! 18 zone-based colors, 10 building types, urban variations (parks, plazas), smart zone preferences. Revolutionary roads-first generation with perfect adjacency.",
    "category": "Add Mesh",
    "doc_url": "",
    "tracker_url": ""
}
